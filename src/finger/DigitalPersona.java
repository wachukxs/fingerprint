...
public class DigitalPersona implements Reader.CaptureCallback, Engine.EnrollmentCallback {
    ...
    public void CaptureResultEvent(Reader.CaptureResult result) {
        ...
        System.out.println("CaptureResultEvent:");
    ...
    public void EnrollFingerprint(int timeout) {
        ...
        try {
            ...
            System.out.println("End of enrollment process, enrollmentFmd:");
            System.out.println(enrollmentFmd);
        } catch (UareUException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void readFingerPrint(int timeout) {
        ...
        try {
            ...
            if (bReady) {
                ...
                //CaptureResult r = m_Reader.CaptureAsync(Fid.Format.ANSI_381_2004, Reader.ImageProcessing.IMG_PROC_DEFAULT, 500, timeout, this);
                CaptureResult r = m_Reader.Capture(Fid.Format.ANSI_381_2004, Reader.ImageProcessing.IMG_PROC_DEFAULT, 500, timeout);
                System.out.println("async event sent for reading fingerprint");
                long starttime = new java.util.Date().getTime();
                while (!bReceivedResult && new java.util.Date().getTime() - starttime < timeout) {
                    try {
                        Thread.sleep(100);
                        System.out.println(". sleeping2... I think waiting");
                    } catch (InterruptedException e) {
                        // TODO Auto-generated catch block
                        e.printStackTrace();
                    }
